...
<template>
  <div class="article-container">
    <n-space vertical v-if="!data.length"
          ...
          <div class="article-card">
            <n-card :bordered="false" style="--n-color: none;">
              <template #default>
                ...
                <a href="javascript: void(0)" v-if="item.thumbnail && innerWidth > 768">
