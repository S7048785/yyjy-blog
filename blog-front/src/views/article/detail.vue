  ...
  <div class="detail-container" ref="el">
    ...
    <div class="article-panel" v-show="data.id">
      <n-flex vertical :size="20">
        ...
        <n-float-button @click="scrollToTop" v-show="showButton" position="relative" style="width: 50px; min-height: 50px">
          <n-badge :max="999" :offset="[6, -8]" color="#aaa">
            <n-icon size="28">
              <svg fill="#aaa" t="1747215709061" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="23963" width="200" height="200"><path d="M128 128h768v85.333333H128V128z m384 110.336l-30.165333 30.165333-170.666667 170.666667-30.165333 30.165333L341.333333 529.664l30.165334-30.165333L469.333333 401.664V896h85.333334V401.664l97.834666 97.834667 30.165334 30.165333L742.997333 469.333333l-30.165333-30.165333-170.666667-170.666667L512 238.336z" p-id="23964"></path></svg>
              <!--              <ChatbubbleOutline/>-->
            </n-icon>
          </n-badge>
        </n-float-button>
