...
import {AlbumsOutline, BookOutline, GridOutline, ImageOutline, PlanetOutline, SearchOutline} from "@vicons/ionicons5"
  ...
  <div class="home">
    <div class="header">
      <div class="header-left">
        <n-avatar
            @click="emitter.emit('toggleLoading')"
            round
            :size="48"
            src="/img/avatar.jpg"
        />
      ...
      <div class="header-right">
        <n-button text color="#333" style="font-size: 24px">
          <n-icon>
            <SearchOutline/>
          </n-icon>
        </n-button>
    ...
    <div class="footer">
      <div>
        ...
        <a href="https://x.com/YYJY_i" target="_blank">
          <n-icon size="24">
        ...
        <a href="https://github.com/S7048785" target="_blank">
          <n-icon size="24">
